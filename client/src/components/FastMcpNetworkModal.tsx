  ...
  const tools = [
    {
      name: "get_sop_by_id",
      description:
        "Retrieves approved SOP steps & rules for autonomous agent execution.",
    ...
    },
    {
      ...
      description:
        "Searches approved operational procedures by keyword or category.",
    ...
    },
    {
      ...
      description:
        "Fetches SOP details alongside immutable version evolution snapshots.",
    ...
    },
    {
      ...
      description:
        "Submits real-time human approval ticket to manager dashboard for high-risk SOPs.",
    ...
    },
    {
      ...
      description:
        "Checks resolution status of a pending manager approval request.",
    ...
    },
    {
      ...
      description:
        "Executes step against target systems (Stripe, GitHub, Postgres, Slack, Admin CLI) via tool registry.",
    ...
    },
    {
      ...
      description:
        "Reports execution outcomes back to Company Brain observability logs.",
        ...
        <header className="flex items-start justify-between gap-4 border-b border-black/[0.06] p-6">
          <div className="space-y-1">
            ...
            <h2 className="text-[21px] font-semibold tracking-tight text-[#1d1d1f]">
              FastMCP Agent Network
            </h2>
            <p className="text-[12.5px] text-[#6e6e73]">
              Exposing verified procedural skills to Claude, Cursor, and
              autonomous AI agents over FastMCP.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="flex-1 space-y-5 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div className="rounded-2xl border border-green-200 bg-green-50/60 p-4 space-y-1">
              ...
              <p className="text-[16px] font-bold text-green-900 font-mono">
            ...
            <div className="rounded-2xl border border-purple-200 bg-purple-50/60 p-4 space-y-1">
              ...
              <p className="text-[16px] font-bold text-purple-900">
                7 Active Tools
              </p>
              <p className="text-[11px] text-purple-700">
                FastMCP v2.5.0 Protocol
              </p>
            </div>
          </div>

          <div className="space-y-3">
            <h3 className="text-[11.5px] font-semibold text-[#6e6e73] uppercase">
              Exposed Agent Tool Capabilities ({tools.length})
            </h3>
            <div className="space-y-2.5">
              {tools.map((t) => (
                <div
                  key={t.name}
                  className="flex flex-col gap-1.5 rounded-2xl border border-black/[0.08] bg-white/80 p-4 shadow-sm"
                >
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                      <Terminal className="h-4 w-4 text-[#0071e3]" />
                      <code className="font-mono text-[13.5px] font-bold text-[#1d1d1f]">
                        {t.name}
                      </code>
                    </div>
