      ...
      <div className="mt-auto flex gap-2 pt-1">
        ...
        {sop.isStale && onConfirm ? (
          <button
            type="button"
            onClick={onConfirm}
            className="glass-button specular flex h-11 flex-1 items-center justify-center gap-1.5 overflow-hidden rounded-2xl px-5 text-[13px] font-medium text-amber-800 active:scale-95"
          >
