...
export function TeachBrainModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      />
      <div className="glass-panel relative flex max-h-[88vh] w-full max-w-2xl flex-col overflow-hidden rounded-[24px] duration-300 ease-out animate-in fade-in zoom-in-95 shadow-[0_16px_50px_rgba(0,0,0,0.1)]">
        <header className="flex items-start justify-between gap-4 border-b border-black/[0.06] p-6">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="flex h-6 w-6 items-center justify-center rounded-lg border border-[#0071e3]/20 bg-[#0071e3]/[0.08] text-[#0071e3]">
                ...
                <div key={idx} className="flex items-center gap-2">
                  ...
                  {steps.length > 1 && (
                    <button
                      ...
                      className="glass-button flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-xl text-[#6e6e73] hover:text-[#dc2626] active:scale-95"
                    >
