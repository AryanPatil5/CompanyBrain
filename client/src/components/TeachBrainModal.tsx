        ...
        <form onSubmit={handleSubmit} className="flex flex-1 flex-col overflow-hidden">
          ...
          <footer className="flex items-center justify-end gap-2 border-t border-black/[0.06] p-5">
            ...
            <button
              ...
              className="specular flex h-11 items-center gap-2 overflow-hidden rounded-2xl border border-[#0071e3]/30 bg-[#0071e3] px-6 text-[13px] font-medium text-white shadow-[0_2px_10px_rgba(0,113,227,0.25)] transition-transform duration-300 hover:-translate-y-0.5 disabled:opacity-50"
            >
