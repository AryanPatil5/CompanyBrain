                        ...
                        <div className="flex items-center justify-end gap-2 pt-1">
                          {isConnected ? (
                            ...
                            <div className="flex items-center gap-2">
                              <button
                                type="button"
                                onClick={() => openWizard(item.provider)}
                                title="Configure OAuth App Credentials"
                                className="flex items-center gap-1 rounded-lg border border-slate-200 bg-slate-50 px-2.5 py-1.5 text-[11.5px] font-medium text-slate-700 hover:bg-slate-100 active:scale-95 transition-all"
                              >
